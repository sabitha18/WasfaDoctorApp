...
class SkuListAdapter(
    private val onSkuSelected: (SKU) -> Unit
) : RecyclerView.Adapter<SkuListAdapter.SkuViewHolder>() {

    private var skuList: List<SKU> = emptyList()

    fun submitList(newList: List<SKU>) {
        skuList = newList
