...
class InfluencerAdapter(
    private val originalList: List<InfluencerListResponse>,
    private val onItemSelected: (InfluencerListResponse) -> Unit,
    private val preSelectedName: String? = null
) : RecyclerView.Adapter<InfluencerAdapter.ViewHolder>() {

    private var filteredList: MutableList<InfluencerListResponse> = originalList.toMutableList()
