package com.wasfa.doctor.ui.pres.edit
...
class EditRXFragment : Fragment() {
    ...
    private fun managePatient(data: List<PatientInfo>?){
        ...
        binding.editAltPhone.setText(data?.get(0)?.alt_phone)
        ...
        binding.editCivilId.isFocusable = false
        binding.editCivilId.isClickable = false

        binding.editAltPhone.isFocusable = false
        binding.editAltPhone.isClickable = false

        binding.editFullName.isFocusable = false
        binding.editFullName.isClickable = false
...
//        }
    ...
    private fun handleClick() {
        ...
        binding.imgCart.setOnClickListener {
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, DoctorRXCartEditFragment())
                .addToBackStack(null)
                .commit()
        }
